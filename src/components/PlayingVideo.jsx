...
export const PlayingVideo = () => {
  ...
  return (
    <div className=" flex justify-center flex-row h-[calc(100%-56px)] mt-7">
      <div className="w-full max-w-[1580px] flex flex-col lg:flex-row">
        <div className="flex flex-col lg:w-[calc(100%-300px)] xl:w-[100%-400px] lg:px-16 xl:px-20 px-4 py-3 lg:py-1">
          <div className="h-[250px] md:h-[500px] ml-[-16px] mr-[-16px] lg:ml-0 lg:mr-0">
            <ReactPlayer
        ...
        <div className="flex flex-col px-1 py-6 h-[calc(100vh-4.625rem)] overflow-y-scroll overflow-x-hidden lg:w-[350px] xl:w-[400px]">
